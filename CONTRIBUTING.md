...
1. In Github, send a pull request to `github-statistics-jvm:master`.
...
You will need Java SDK in appropriate version.
...
set JAVA_ENVIRONMENT=Development // cmd
$Env:JAVA_ENVIRONMENT = "Development" // powershell
export JAVA_ENVIRONMENT=Development // bash

# publish new image to docker hub
$ docker docker build -t username/github-statistics-jvm . && docker push username/github-statistics-jvm
```
...
[github]: https://Github.org/rafalschmidt97/github-statistics-jvm
