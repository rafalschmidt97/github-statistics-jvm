This repository is **not a part of Allegro** recruitment process. It includes the api for 
gathering information about user repositories. Just for fun to practise multi-module projects 
with gradle. Unfortunately no one has ever invited me for a Java interview yet. Anyway 
I'm extremely proud that I've passed the entire .net interview as the process was quite demanding. 

Created with Java 14, Lombok and Spring Boot.

// TODO: CI configured with TravisCI (build + tests).

// TODO: Add badge

## Recruitment task for .net position
